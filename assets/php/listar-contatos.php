...
/* $query_usuarios = "SELECT con_nome, con_telefone, con_email, con_nascimento, con_observacoes FROM tb_contatos ORDER BY con_id DESC LIMIT :inicio, :quantidade"; */
$query_usuarios = "SELECT con_nome, con_telefone, con_email, con_nascimento, con_observacoes FROM tb_contatos ";
...
while($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)) {
    ...
    $registro[] = "<button class='btn btn-primary editar'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil' viewBox='0 0 16 16'>
    ...
    $registro[] = "<button class='btn btn-danger excluir'>
